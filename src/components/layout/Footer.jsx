...
export default function Footer() {
  return (
    <footer className="bg-[#e4e4df]">
      <div className="mx-auto max-w-7xl px-6 py-12 flex gap-6 md:flex md:items-center md:justify-between flex-col lg:px-8">
        <p className="mt-8 text-center text-sm/6 text-black md:order-1 md:mt-0">
          IICombined Co., Ltd. | Business Registration Number: 119-86-38589{' '}
          <br />
          Representative: Hangook Kim | 41, Eoulmadang-Ro 5-Gil, Mapo-Gu, Seoul
          <br />
          ©NUDAKE
        </p>
